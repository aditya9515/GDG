...
const SESSION_RELOAD_KEY = 'reliefops_session_reload_started'
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    window.addEventListener(SESSION_EXPIRED_EVENT, reloadForFreshSession)
    return () => window.removeEventListener(SESSION_EXPIRED_EVENT, reloadForFreshSession)
  }, [])
